...
public class FilterContactTypeViewModel extends BaseBottomSheetViewModel {
    ...
    private void updateFilterContactTypes() {
        ...
        ArrayList<FilterContactTypeUi> types = new ArrayList<>();
        types.add(createAllSelectedItem(contacts));
        for(String string : contacts){
            FilterContactTypeUi type = createFilterContactType(string);
            types.add(type);
        }
        ...
        filterContactTypesLiveDate.setValue(types);
